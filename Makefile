...
generate-types: ## Generate TypeScript types from OpenAPI
	...
	@pnpm --filter @reviewate/api-types exec openapi-ts --input $(CURDIR)/packages/api-types/openapi.json --output $(CURDIR)/packages/api-types --client @hey-api/client-fetch
